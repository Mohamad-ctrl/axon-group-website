...
export default function JobForm({
  ...
  return (
    <form className="form" action={action}>
      ...
      <Field label="Company" name="company" required defaultValue={job?.company.en} placeholder="e.g. Axon Pools" />
      <Field label="Location" name="location" required defaultValue={job?.location.en} placeholder="e.g. Abu Dhabi, UAE" />
